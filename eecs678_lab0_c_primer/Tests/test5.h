...
int test5() {
    printf("Running Test 5: Linked List Functions\n");
    int points = 10;

    // Step 1: Create two linked lists with identical elements
    ...
    if (mergedList == NULL) {
        ...
        printf("Merged List: ");
        printList(mergedList);  // Expected output: "1 -> 1 -> 3 -> 3 -> 5 -> 5 -> NULL"
